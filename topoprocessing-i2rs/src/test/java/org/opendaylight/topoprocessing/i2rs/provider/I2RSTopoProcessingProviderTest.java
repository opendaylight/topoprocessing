...
import org.opendaylight.topoprocessing.i2rs.TopoProcessingProviderI2RS;
...
public class I2RSTopoProcessingProviderTest {
    ...
    public void testStartup() throws Exception {
        pingPongDataBroker = new PingPongDataBroker(dataBroker);
        ...
        topoProcessingProvider = new TopoProcessingProviderImpl(
                schemaService, pingPongDataBroker, nodeSerializer, rpcServices, DatastoreType.OPERATIONAL);
        topoProcessingProvider.startup();
        TopoProcessingProviderI2RS I2RSProvider = new TopoProcessingProviderI2RS();
        I2RSProvider.startup(topoProcessingProvider);
