...
public class I2RSOverlayItemTranslatorNodeTest {
    ...
    public void testAggregatedTerminationPointsWithinNodes() {
        ...
        LeafSetNode tpRefs1 = ImmutableLeafSetNodeBuilder.create().withNodeIdentifier(NodeIdentifier.create(TopologyQNames.TP_REF))
        ...
        LeafSetNode tpRefs2 = ImmutableLeafSetNodeBuilder.create().withNodeIdentifier(NodeIdentifier.create(TopologyQNames.TP_REF))
                .withChild(ImmutableLeafSetEntryNodeBuilder.create()
