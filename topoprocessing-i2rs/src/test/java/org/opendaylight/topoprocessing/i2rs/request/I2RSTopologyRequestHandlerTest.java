...
import org.opendaylight.yang.gen.v1.urn.opendaylight.i2rs.augmentations.rev150827.CorrelationAugmentBuilder;
...
public class I2RSTopologyRequestHandlerTest {
    ...
    public void testTopologyWithoutAugmentation() {
        ...
        handler = new I2RSTopologyRequestHandler(mockDomDataBroker, mockSchemaHolder, mockRpcServices,
    ...
    public void testCorrelationMissingInAugment() {
        ...
        cBuilder.setOutputModel(Model.I2RS);
        correlationAugmentBuilder.setCorrelations(cBuilder.build());
        networkBuilder.addAugmentation(CorrelationAugment.class, correlationAugmentBuilder.build());
        Entry<?, DataObject> entry = Maps.immutableEntry(identifier, (DataObject) networkBuilder.build());
        handler = new I2RSTopologyRequestHandler(mockDomDataBroker, mockSchemaHolder, mockRpcServices,
                (Entry<InstanceIdentifier<?>, DataObject>) entry);
        handler.processNewRequest();
    ...
    private static CorrelationAugmentBuilder createCorrelation(Class<? extends CorrelationBase> correlationBase,
        ...
        correlationsBuilder.setOutputModel(Model.I2RS);
        CorrelationAugmentBuilder correlationAugmentBuilder = new CorrelationAugmentBuilder();
    ...
    public void testCorrelationItemNull() {
        ...
        mappingBuilder1.setInputModel(Model.I2RS);
    ...
    public void testConfigurationAndOperationListenerRegistration() {
        ...
        modelAdapters.put(Model.I2RS, new I2RSModelAdapter());
    ...
    public void testIpv4AddressFiltration() {
        ...
        filterBuilder1.setInputModel(Model.I2RS);
