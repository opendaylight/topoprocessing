...
public class I2RSModelAdapter implements ModelAdapter {
    ...
    @Override
    public UnderlayTopologyListener registerUnderlayTopologyListener(PingPongDataBroker dataBroker, String underlayTopologyId,
        ...
        I2RSUnderlayTopologyListener listener = new I2RSUnderlayTopologyListener(dataBroker, underlayTopologyId, correlationItem);
