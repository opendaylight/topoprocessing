...
public class NTTopologyRequestHandlerTest {
    ...
    private TestingBroker testingBroker;
    ...
    public void setUp() {
        ...
        testingBroker = new TestingBroker();
    ...
    public void testCorrelationMissingInAugment() {
        ...
        cBuilder.setOutputModel(Model.NetworkTopology);
    ...
    private static CorrelationAugmentBuilder createCorrelation(Class<? extends CorrelationBase> correlationBase,
        ...
        correlationsBuilder.setOutputModel(Model.NetworkTopology);
        CorrelationAugmentBuilder correlationAugmentBuilder = new CorrelationAugmentBuilder();
    ...
    private class TestingBroker extends TestingDOMDataBroker implements DOMDataTreeChangeService {
