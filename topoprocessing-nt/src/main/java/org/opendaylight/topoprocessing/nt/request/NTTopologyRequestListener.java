...
public class NTTopologyRequestListener extends TopologyRequestListener {
    ...
    @Override
    protected TopologyRequestHandler createTopologyRequestHandler(DOMDataBroker dataBroker, DOMDataTreeChangeService domDataTreeChangeService,
            GlobalSchemaContextHolder schemaHolder, RpcServices rpcServices,
            Map.Entry<InstanceIdentifier<?>,DataObject> fromNormalizedNode) {

        return new NTTopologyRequestHandler(dataBroker, domDataTreeChangeService, schemaHolder, rpcServices, fromNormalizedNode);
    }
