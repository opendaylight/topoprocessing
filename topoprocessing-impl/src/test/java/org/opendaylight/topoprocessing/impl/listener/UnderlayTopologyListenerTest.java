...
public class UnderlayTopologyListenerTest {
    ...
    public void testAggregation() {
        ...
        listener.readExistingData(YangInstanceIdentifier.builder().build(), LogicalDatastoreType.OPERATIONAL);
    ...
    public void testReadExistingData() {
        ...
        LogicalDatastoreType dsType = LogicalDatastoreType.OPERATIONAL;
        ...
        Mockito.when(readTransaction.read(dsType, path)).thenReturn(checkedFuture);

        listener.readExistingData(path, dsType);
    }
}
