...
public class LogicalNodeToNodeTranslatorTest {
    ...
    public void testTerminationPoint() {
        ...
        tpKeyValues1.put(TopologyQNames.TP_ID, tpId);
        tpKeyValues1.put(TopologyQNames.TP_REF, tpRef);
        Map<QName, Object> tpKeyValues2 = new HashMap<>();
        tpKeyValues2.put(TopologyQNames.TP_ID, tpId);
        tpKeyValues2.put(TopologyQNames.TP_REF, tpRef);
        Map<QName, Object> tpKeyValues3 = new HashMap<>();
        tpKeyValues3.put(TopologyQNames.TP_ID, tpId);
        tpKeyValues3.put(TopologyQNames.TP_REF, tpRef);

        MapNode terminationPoints = ImmutableNodes.mapNodeBuilder(TerminationPoint.QNAME)
                .withChild(ImmutableNodes.mapEntryBuilder(TerminationPoint.QNAME, TopologyQNames.TP_ID, tpId)
                                .withChild(ImmutableNodes.leafNode(TopologyQNames.TP_ID, tpId))
                                .withChild(ImmutableNodes.leafNode(TopologyQNames.TP_REF, tpRef))
                                .build()
                )
                .withChild(ImmutableNodes.mapEntryBuilder(TerminationPoint.QNAME, TopologyQNames.TP_ID, tpId)
                                .withChild(ImmutableNodes.leafNode(TopologyQNames.TP_ID, tpId))
