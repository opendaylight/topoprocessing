...
public class PathTranslatorTest {
    ...
    private static SchemaContext createTestContext() throws IOException, YangSyntaxErrorException, ReactorException {
    ...
    @Before
    public void startup() throws URISyntaxException, ParseException, IOException, YangSyntaxErrorException, ReactorException {
    ...
    public void testUnexistingModuleName()
        ...
        SchemaContext schemaContext2 = null;
        try{
        schemaContext2 = parseYangSources(modules);
        }catch(Exception e){
