...
public class TopologyManagerTest {
    ...
    public void setUp() {
        ...
        manager = new TopologyManager(mockRpcServices, mockSchemaHolder, identifier, Model.NetworkTopology);
    ...
    public void addLogicalNode() {
        ...
        Mockito.verify(writer, Mockito.times(1)).writeItem((OverlayItemWrapper) any(), (CorrelationItemEnum) any());
    }
    ...
    public void addTwoLogicalNodesInTwoCalls() {
        ...
        Mockito.verify(writer, Mockito.times(2)).writeItem((OverlayItemWrapper) any(), (CorrelationItemEnum) any());
    }
    ...
    public void removeTheOnlyExistingNode() {
        ...
        Mockito.verify(writer, Mockito.times(0)).writeItem((OverlayItemWrapper) any(), (CorrelationItemEnum) any());
        Mockito.verify(writer, Mockito.times(1)).deleteItem((OverlayItemWrapper) any(), (CorrelationItemEnum) any());
    ...
    public void removeUnexistingNode() {
        ...
        Mockito.verify(writer, Mockito.times(0)).writeItem((OverlayItemWrapper) any(), (CorrelationItemEnum) any());
        Mockito.verify(writer, Mockito.times(0)).deleteItem((OverlayItemWrapper) any(), (CorrelationItemEnum) any());
        Assert.assertEquals(1, manager.getNodeWrappers().size());
    }
