 ...
 *
 */
public class NoopDataTreeCandidateNode implements DataTreeCandidateNode {
    ...
    public void setDataAfter(NormalizedNode<?,?> dataAfter) {
        Optional<NormalizedNode<?,?>> optNn = Optional.of(dataAfter);
    }
