...
public class PreAggregationFiltratorTest {
    ...
    private static final TestNodeCreator dummyCreator = new TestNodeCreator();
    ...
    public void testProcessCreatedChanges() {
        ...
        map.put(0, dummyCreator.createLeafNodeWithIpAddress("192.168.1.1"));
        YangInstanceIdentifier yiid = dummyCreator.createNodeIdYiid(nodeId);
        UnderlayItem item = new UnderlayItem(null, map, TOPOLOGY_ID, nodeId, CorrelationItemEnum.Node);
    ...
    public void testProcessUpdatedChanges() {
        ...
        String nodeId = "node:1";
        map.put(0, dummyCreator.createLeafNodeWithIpAddress("192.168.1.4"));
        YangInstanceIdentifier yiid = dummyCreator.createNodeIdYiid(nodeId);
        UnderlayItem item = new UnderlayItem(null, map, TOPOLOGY_ID, nodeId, CorrelationItemEnum.Node);
        ...
        map.put(0, dummyCreator.createLeafNodeWithIpAddress("192.168.1.5"));
        yiid = dummyCreator.createNodeIdYiid(nodeId);
        item = new UnderlayItem(null, map, TOPOLOGY_ID, nodeId, CorrelationItemEnum.Node);
        filtrator.processUpdatedChanges(yiid, item, TOPOLOGY_ID);
