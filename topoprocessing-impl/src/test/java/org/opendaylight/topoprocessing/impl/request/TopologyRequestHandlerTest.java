...
public class TopologyRequestHandlerTest {
    ...
    public void testProcessNewRequestAggregation(){
        ...
        verify(mappingMock, times(12)).getInputModel();
    ...
    public void testProcessNewRequestFiltrationAggregation(){
        ...
        verify(mappingMock, times(15)).getInputModel();
    ...
    private void setTestHandler(){
        ...
        when(modelAdapterMock.registerUnderlayTopologyListener((PingPongDataBroker)any(),(String) any(),(CorrelationItemEnum) any(),
                                                               (DatastoreType) any(),(TopologyAggregator) any(),(List) any(),
                                                               (YangInstanceIdentifier) any())).thenReturn(underlayTopologyListenerMock);
        when(pathTranslatorMock.translate("f1",CorrelationItemEnum.Node,schemaHolderMock,null)).thenReturn(yangInstanceIdentifierMock);
