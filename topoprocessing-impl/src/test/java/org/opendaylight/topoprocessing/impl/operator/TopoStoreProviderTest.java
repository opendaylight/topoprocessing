...
public class TopoStoreProviderTest {
    ...
    public void testInitializeTwoStores() {
        ...
        Assert.assertEquals(false, provider.getTopologyStore(TOPOLOGY1_ID).isAggregateInside());
        Assert.assertEquals(false, provider.getTopologyStore(TOPOLOGY2_ID).isAggregateInside());
    }
