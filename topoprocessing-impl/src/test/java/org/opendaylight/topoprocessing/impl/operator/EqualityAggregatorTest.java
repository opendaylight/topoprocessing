...
public class EqualityAggregatorTest {
    ...
    public void setUp() throws Exception {
        ...
        UnderlayItem physicalNode1 = new UnderlayItem(mockNormalizedNode1, leafNode11, TOPO1, "11", CorrelationItemEnum.Node);
        UnderlayItem physicalNode2 = new UnderlayItem(mockNormalizedNode1, leafNode12, TOPO2, "12", CorrelationItemEnum.Node);
    ...
    public void testProcessCreatedChanges() throws Exception {
        ...
        Mockito.verify(mockManager, Mockito.times(1)).addLogicalNode((OverlayItem) any());
        Mockito.verify(mockManager, Mockito.times(0)).removeOverlayItem((OverlayItem) any());
        Mockito.verify(mockManager, Mockito.times(0)).updateLogicalNode((OverlayItem) any());
        ...
        Mockito.verify(mockManager, Mockito.times(1)).addLogicalNode((OverlayItem) any());
        Mockito.verify(mockManager, Mockito.times(0)).removeOverlayItem((OverlayItem) any());
        Mockito.verify(mockManager, Mockito.times(1)).updateLogicalNode((OverlayItem) any());
    }
    ...
    public void testProcessRemovedChanges() throws Exception {
        ...
        Mockito.verify(mockManager, Mockito.times(2)).updateLogicalNode((OverlayItem) any());
    ...
    public void testProcessUpdatedChanges1() throws Exception {
        ...
        Mockito.verify(mockManager, Mockito.times(2)).addLogicalNode((OverlayItem) any());
        Mockito.verify(mockManager, Mockito.times(0)).removeOverlayItem((OverlayItem) any());
    ...
    public void testProcessUpdatedChanges2() throws Exception {
        ...
        Mockito.verify(mockManager, Mockito.times(3)).updateLogicalNode((OverlayItem) any());
    }
    ...
    public void test() throws Exception {
        ...
        Mockito.verify(mockManager, Mockito.times(0)).addLogicalNode((OverlayItem) any());
        Mockito.verify(mockManager, Mockito.times(0)).removeOverlayItem((OverlayItem) any());
        Mockito.verify(mockManager, Mockito.times(0)).updateLogicalNode((OverlayItem) any());
