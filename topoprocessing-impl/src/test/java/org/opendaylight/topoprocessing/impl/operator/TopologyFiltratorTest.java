...
public class TopologyFiltratorTest {
    ...
    public void testProcessChanges() {
        ...
        Mockito.verify(mockTopologyManager, Mockito.times(3)).addLogicalNode((OverlayItem) Matchers.any());
        ...
        Mockito.verify(mockTopologyManager, Mockito.times(4)).addLogicalNode((OverlayItem) Matchers.any());
        ...
        map.put(creator.createNodeIdYiid(nodeId), new UnderlayItem(
                ...
                CorrelationItemEnum.Node));
        filtrator.processUpdatedChanges(map, TOPOLOGY_NAME);
        Mockito.verify(mockTopologyManager).updateLogicalNode((OverlayItem) Matchers.any());
