...
public class NodeIpv4Test {
    ...
    public void testMask32() {
        ...
        NodeIpv4 nodeIpv4 = new NodeIpv4(ipPrefix, path);

        boolean filtered1 = nodeIpv4.isFiltered(this.createPhysicalNode("192.168.1.1"));
        Assert.assertFalse("Node should pass the filtrator", filtered1);

        boolean filtered2 = nodeIpv4.isFiltered(this.createPhysicalNode("192.168.1.2"));
        Assert.assertTrue("Node should not pass the filtrator", filtered2);

        boolean filtered3 = nodeIpv4.isFiltered(this.createPhysicalNode("192.168.2.1"));
        Assert.assertTrue("Node should not pass the filtrator", filtered3);

        boolean filtered4 = nodeIpv4.isFiltered(this.createPhysicalNode("192.169.1.1"));
        Assert.assertTrue("Node should not pass the filtrator", filtered4);

        boolean filtered5 = nodeIpv4.isFiltered(this.createPhysicalNode("193.168.1.1"));
    ...
    public void testMask24() {
        ...
        boolean filtered1 = nodeIpv4.isFiltered(this.createPhysicalNode("192.168.1.2"));
        Assert.assertFalse("Node should pass the filtrator", filtered1);

        boolean filtered2 = nodeIpv4.isFiltered(this.createPhysicalNode("192.168.2.1"));
        Assert.assertTrue("Node should not pass the filtrator", filtered2);

        boolean filtered3 = nodeIpv4.isFiltered(this.createPhysicalNode("192.169.1.1"));
        Assert.assertTrue("Node should not pass the filtrator", filtered3);

        boolean filtered4 = nodeIpv4.isFiltered(this.createPhysicalNode("193.168.1.1"));
        Assert.assertTrue("Node should not pass the filtrator", filtered4);
    }
    ...
    public void testMissingIp() {
        ...
        boolean filtered = nodeIpv4.isFiltered(new PhysicalNode(
