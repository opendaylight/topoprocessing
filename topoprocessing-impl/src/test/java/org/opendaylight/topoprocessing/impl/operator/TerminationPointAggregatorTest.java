...
public class TerminationPointAggregatorTest {
    ...
    public void testCreateNode() {
        ...
        for (MapEntryNode mapEntryNode : mapEntryNodes) {
            ...
            if (3 == tpRefs.size()) {
//                TP entry node 1
                Assert.assertEquals("TP1 reference1", TP_ID5, ((LeafSetEntryNode) tpRefs.get(0).getValue()).getValue());
                Assert.assertEquals("TP1 reference2", TP_ID1, ((LeafSetEntryNode) tpRefs.get(1).getValue()).getValue());
                Assert.assertEquals("TP1 reference3", TP_ID3, ((LeafSetEntryNode) tpRefs.get(2).getValue()).getValue());
            } else if (2 == tpRefs.size()) {
//                TP entry map node 2
                Assert.assertEquals("TP1 reference1", TP_ID4, ((LeafSetEntryNode) tpRefs.get(0).getValue()).getValue());
                Assert.assertEquals("TP1 reference2", TP_ID2, ((LeafSetEntryNode) tpRefs.get(1).getValue()).getValue());
