...
public class TopologyWriterTest {
    ...
    private final YangInstanceIdentifier topologyIdentifierNTModel = YangInstanceIdentifier
    ...
    private final YangInstanceIdentifier nodeIdentifierNTModel = YangInstanceIdentifier
            .builder(topologyIdentifierNTModel).node(Node.QNAME).build();
    private final YangInstanceIdentifier linkIdentifierNTModel = YangInstanceIdentifier
            .builder(topologyIdentifierNTModel).node(Link.QNAME).build();

    private final YangInstanceIdentifier topologyIdentifierI2rsModel = YangInstanceIdentifier
    ...
    private final YangInstanceIdentifier nodeIdentifierI2rsModel = YangInstanceIdentifier
    ...
    private final YangInstanceIdentifier linkIdentifierI2rsModel = YangInstanceIdentifier
            .builder(topologyIdentifierI2rsModel).node(org.opendaylight.yang.gen.v1.urn.ietf.params
            .xml.ns.yang.ietf.network.topology.rev150608.network.Link.QNAME)
    .build();
    ...
    public void testDeleteItemNTModel() {
        OverlayItem overlayItem = new OverlayItem(new ArrayList<UnderlayItem>(), CorrelationItemEnum.Node);
