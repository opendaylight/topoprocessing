...
public class TopologyAggregatorTest {
    ...
    public void testProcessCreatedChanges() throws Exception {
        ...
        Assert.assertEquals(1, aggregator.topologyStores.get(0).getPhysicalNodes().size());
        // three physical nodes in topology store TOPO2 (=get(1))
        Assert.assertEquals(3, aggregator.topologyStores.get(1).getPhysicalNodes().size());
