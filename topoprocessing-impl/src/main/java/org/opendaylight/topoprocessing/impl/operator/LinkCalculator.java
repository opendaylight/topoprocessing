        ...
        synchronized(this) {
            if (matchedLinks.containsKey(itemIdentifier)) {
                ...
                while(matchedLinksIterator.hasNext()){
                    ...
                    } else if(updatedLink.getSrcNode().equals(oldOverlaySrcNode) == false &&
                                updatedLink.getDstNode().equals(oldOverlayDstNode) ==  false){
                ...
                for(Map.Entry<YangInstanceIdentifier, ComputedLink> updatedLinkEntry: matchedLinksToUpdate.entrySet()){
                    ...
                    if(aggregator != null) {
                        ...
                        OverlayItem overlayItem = wrapUnderlayItem(updatedLink);
