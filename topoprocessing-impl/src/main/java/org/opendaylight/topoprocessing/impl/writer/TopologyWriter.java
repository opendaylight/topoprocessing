...
public class TopologyWriter implements TransactionChainListener {
    ...
    public void writeNode(final OverlayItemWrapper wrapper) {
        ...
        preparedOperations.add(new PutOperation(createNodeIdentifier(wrapper.getId()), node));
        scheduleWrite();
    }
    ...
    public void deleteNode(final OverlayItemWrapper wrapper) {
        preparedOperations.add(new DeleteOperation(createNodeIdentifier(wrapper.getId())));
        scheduleWrite();
    }
