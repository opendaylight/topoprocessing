                ...
                if(ts.getId().equals(topologyId)) {
                    for (Entry<YangInstanceIdentifier, PhysicalNode> updatedEntry : updatedEntries.entrySet()) {
                        ...
                        if (oldPhysicalNode.getLeafNode().equals(updatedEntry.getValue().getLeafNode())) {
                            ...
                            HashMap<YangInstanceIdentifier, PhysicalNode> hashMap =
                                    new HashMap<YangInstanceIdentifier, PhysicalNode>();
                            hashMap.put(updatedEntry.getKey(), updatedEntry.getValue());
                            createLogicalNodeFromPhysicalNodes(hashMap, topologyId, ts);
                        }
                    }
                } else {
                    // option 1
