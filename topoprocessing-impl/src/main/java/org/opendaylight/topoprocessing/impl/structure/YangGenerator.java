...
public class YangGenerator {
    ...
    private YangInstanceIdentifier createYang(String topologyId, CorrelationItemEnum topologyType, int uniqueId) {
        ...
        switch (topologyType) {
            ...
            case Link:
                ...
                yiid.nodeWithKey(Node.QNAME, QName.create("link-id"), uniqueId);
                break;
            case TerminationPoint:
                yiid.node(Node.QNAME);
                yiid.node(TerminationPoint.QNAME);
                yiid.nodeWithKey(Node.QNAME, QName.create("terminationPoint-id"), uniqueId);
                break;
        }
     ...
     */
    public YangInstanceIdentifier getNextYang(String topologyId, CorrelationItemEnum topologyType) {
        return createYang(topologyId, topologyType, getNextId());
    }
}
