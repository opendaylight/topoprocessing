...
public class RpcServices implements DOMRpcProviderService, DOMRpcService, AutoCloseable {
    ...
    @Nonnull
    @Override
    public <T extends DOMRpcImplementation> DOMRpcImplementationRegistration<T> registerRpcImplementation(@Nonnull T t,
            @Nonnull DOMRpcIdentifier... domRpcIdentifiers) {
    ...
    @Override
    public <T extends DOMRpcImplementation> DOMRpcImplementationRegistration<T> registerRpcImplementation(@Nonnull T t,
            @Nonnull Set<DOMRpcIdentifier> set) {
    ...
    @Nonnull
    @Override
    public CheckedFuture<DOMRpcResult, DOMRpcException> invokeRpc(@Nonnull SchemaPath schemaPath,
            @Nullable NormalizedNode<?, ?> normalizedNode) {
