...
import org.opendaylight.yang.gen.v1.urn.opendaylight.topology.correlation.rev150121.RangeNumberAugment;
...
public class RangeNumberFiltratorFactory implements FiltratorFactory {
    ...
    public Filtrator createFiltrator(Filter filter, YangInstanceIdentifier pathIdentifier) {
        return new RangeNumberFiltrator(filter.getAugmentation(RangeNumberAugment.class).getMinNumberValue(),
                filter.getAugmentation(RangeNumberAugment.class).getMaxNumberValue(), pathIdentifier);
    }
}
