 ...
 * @author matus.marko
 */
public class LogicalNodeToNodeConverter {

    private static final Logger LOG = LoggerFactory.getLogger(LogicalNodeToNodeConverter.class);
    ...
    public NormalizedNode<?, ?> convert(
        ...
        LOG.debug("Transforming LogicalNode to Node");
