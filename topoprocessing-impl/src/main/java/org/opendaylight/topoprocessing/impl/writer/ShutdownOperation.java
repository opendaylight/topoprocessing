...
/**
 * Deleting overlay topology (as part of releasing allocated resources)
 * @author andrej.zan
 */
public class ShutdownOperation implements TransactionOperation {
     ...
     */
    public ShutdownOperation(YangInstanceIdentifier identifier) {
