 ...
 * @author matus.marko
 */
public abstract class Specific<T> implements Filtrator {

    private static final Logger LOG = LoggerFactory.getLogger(Specific.class);
    private final YangInstanceIdentifier pathIdentifier;
    private final T value;

    public Specific(T value, YangInstanceIdentifier pathIdentifier) {
