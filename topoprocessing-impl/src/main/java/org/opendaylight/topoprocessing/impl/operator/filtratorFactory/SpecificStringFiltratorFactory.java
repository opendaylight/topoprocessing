...
import org.opendaylight.yang.gen.v1.urn.opendaylight.topology.correlation.rev150121.SpecificNumberAugment;
...
public class SpecificStringFiltratorFactory implements FiltratorFactory {
    ...
    public Filtrator createFiltrator(Filter filter, YangInstanceIdentifier pathIdentifier) {
        return new SpecificValueFiltrator<>(
                filter.getAugmentation(SpecificNumberAugment.class).getSpecificNumber(), pathIdentifier);
    }
}
