...
import org.opendaylight.yang.gen.v1.urn.opendaylight.topology.correlation.rev150121.NodeIpv4Augment;
...
public class Ipv4FiltratorFactory implements FiltratorFactory {
    ...
    public Filtrator createFiltrator(Filter filter, YangInstanceIdentifier pathIdentifier) {
        return new Ipv4AddressFiltrator(filter.getAugmentation(NodeIpv4Augment.class).getIpv4Address(), pathIdentifier);
    }
}
