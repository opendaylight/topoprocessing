 ...
 * @author matus.marko
 */
public class NodeIp implements Filtrator {

    private static final Logger LOG = LoggerFactory.getLogger(NodeIp.class);
     ...
     */
    public NodeIp(IpPrefix value, YangInstanceIdentifier pathIdentifier) {
