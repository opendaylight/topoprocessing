 ...
 * @author matus.marko
 */
public class NodeIpv4 implements Filtrator {

    private static final Logger LOG = LoggerFactory.getLogger(NodeIpv4.class);
     ...
     */
    public NodeIpv4(IpPrefix value, YangInstanceIdentifier pathIdentifier) {
