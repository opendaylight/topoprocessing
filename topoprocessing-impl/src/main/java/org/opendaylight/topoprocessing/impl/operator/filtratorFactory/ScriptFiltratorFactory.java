...
import org.opendaylight.yang.gen.v1.urn.opendaylight.topology.correlation.rev150121.ScriptingAugment;
...
public class ScriptFiltratorFactory implements FiltratorFactory {
    ...
    public Filtrator createFiltrator(Filter filter, YangInstanceIdentifier pathIdentifier) {
        return new ScriptFiltrator(filter.getAugmentation(ScriptingAugment.class).getScripting(), pathIdentifier);
    }
