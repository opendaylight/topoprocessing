...
public abstract class TopologyRequestHandler {
    ...
    /**
     * Default constructor.
     * @param pingPongDataBroker    broker used for transaction operations
     ...
     */
    public TopologyRequestHandler(DOMDataBroker pingPongDataBroker, DOMDataTreeChangeService domDataTreeChangeService, GlobalSchemaContextHolder schemaHolder,
