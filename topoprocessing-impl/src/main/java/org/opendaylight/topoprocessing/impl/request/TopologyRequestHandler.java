...
import org.opendaylight.topoprocessing.impl.operator.filtrator.NodeIpv4Filtrator;
...
public class TopologyRequestHandler {
    ...
    private void iterateFilters(TopologyFiltrator operator, List<Filter> filters, CorrelationItemEnum correlationItem) {
        for (Filter filter : filters) {
            ...
            operator.addFilter(new NodeIpv4Filtrator(filter.getValue(), pathIdentifier));
