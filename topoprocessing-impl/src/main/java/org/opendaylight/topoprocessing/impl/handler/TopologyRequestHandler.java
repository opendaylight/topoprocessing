...
public class TopologyRequestHandler {
    ...
    public void processNewRequest(Topology topology) {
        ...
        try {
            ...
            LOG.warn("Process ended with error: " + e.getMessage());
        }
    }
     ...
     * @return
     */
    private MapNode readData(YangInstanceIdentifier path) throws Exception {
        ...
        if (listenableFuture != null) {
            ...
            try {
                ...
                throw new Exception("Problem to get data from transaction.", e.getCause());
            }
            if (optional != null) {
