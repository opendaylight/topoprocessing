...
public class TopoProcessingProviderImpl implements TopoProcessingProvider {
    ...
    private DOMDataBroker dataBroker; //access to data store
    ...
    public void startup() {
        ...
        LOGGER.error("Datastore type provided: " + dataStoreType.name());
    ...
    public void setDataStoreType(LogicalDatastoreType dataStoreType) {
        LOGGER.error("Datastore type using setter: " + dataStoreType.name());
