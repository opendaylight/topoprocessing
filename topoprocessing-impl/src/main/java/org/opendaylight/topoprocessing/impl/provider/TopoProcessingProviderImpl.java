...
public class TopoProcessingProviderImpl implements TopoProcessingProvider {
    ...
    private DatastoreType dataStoreType; //Configures if framework should listen on CONFIGURATION or OPERATIONAL datastore changes
    ...
    public void setDataStoreType(DatastoreType dataStoreType) {
        LOGGER.error("Datastore type using setter: " + dataStoreType.getName());
