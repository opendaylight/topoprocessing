...
public class TopoProcessingProviderImpl implements TopoProcessingProvider {
    ...
    @Override
    public void registerFiltratorFactory(Class<? extends FilterBase> filtrator,
            FiltratorFactory filtratorFactory) {
        topologyRequestListener.registerFiltrator(filtrator, filtratorFactory);
    }

    @Override
    public void unregisterFiltratorFactory(Class<? extends FilterBase> filtrator) {
        topologyRequestListener.unregisterFiltrator(filtrator);
    }
