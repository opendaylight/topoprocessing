...
public class TopoProcessingProviderImpl implements TopoProcessingProvider {
    ...
    @Override
    public void registerModelAdapter(Model model) {
        ModelAdapter modelAdapter = null;
        switch(model){
        case NetworkTopology: {
            modelAdapter = new NTModelAdapter();
        }
        case OpendaylightInventory: {
            modelAdapter = new InvModelAdapter();
        }
        //case I2RS { modelAdapter = new I2RSModelAdapter();}
        }
