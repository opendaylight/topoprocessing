...
public interface TopologyOperator {
     ...
     * @param topologyId
     */
    Map<YangInstanceIdentifier, ?> processCreatedChanges(Map<YangInstanceIdentifier, PhysicalNode> createdEntries, final String topologyId);
     ...
     * @param topologyId
     */
    Map<YangInstanceIdentifier, ?> processUpdatedChanges(Map<YangInstanceIdentifier, PhysicalNode> updatedEntries, String topologyId);
