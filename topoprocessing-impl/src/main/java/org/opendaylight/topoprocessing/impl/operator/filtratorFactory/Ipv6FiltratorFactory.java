...
import org.opendaylight.yang.gen.v1.urn.opendaylight.topology.correlation.rev150121.Ipv6AddressAugment;
...
public class Ipv6FiltratorFactory implements FiltratorFactory {
    ...
    public Filtrator createFiltrator(Filter filter, YangInstanceIdentifier pathIdentifier) {
        return new Ipv6AddressFiltrator(filter.getAugmentation(Ipv6AddressAugment.class).getIpv6Address(), pathIdentifier);
    }
