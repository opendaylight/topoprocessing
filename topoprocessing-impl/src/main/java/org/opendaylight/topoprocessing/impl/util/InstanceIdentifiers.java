...
public final class InstanceIdentifiers {
     ...
     */
    public static YangInstanceIdentifier relativeItemIdIdentifier(CorrelationItemEnum correlationItem, Model model) {
        YangInstanceIdentifier itemIdIdentifier;
        switch (correlationItem) {
        case Node:
            itemIdIdentifier = model != Model.I2RS ? RELATIVE_NODE_ID_IDENTIFIER : I2RS_RELATIVE_NODE_ID_IDENTIFIER;
            break;
        case Link:
            itemIdIdentifier = model != Model.I2RS ? RELATIVE_LINK_ID_IDENTIFIER : I2RS_RELATIVE_LINK_ID_IDENTIFIER;
            break;
        case TerminationPoint:
            itemIdIdentifier = model != Model.I2RS ? RELATIVE_TP_ID_IDENTIFIER : I2RS_RELATIVE_TP_ID_IDENTIFIER;
            break;
        default:
