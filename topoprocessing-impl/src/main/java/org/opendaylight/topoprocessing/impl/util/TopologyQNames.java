...
public final class TopologyQNames {
    ...
    public static final QName I2RS_TP_REF = QName.create(
            org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf
            .network.topology.rev150608.network.node.termination.point.SupportingTerminationPoint.QNAME, "tp-ref").intern();
    /** I2RS model supporting-termination-point network-ref QName */
    public static final QName I2RS_TP_NETWORK_REF = QName.create(
            org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf
            .network.topology.rev150608.network.node.termination.point.SupportingTerminationPoint.QNAME, "network-ref").intern();
    /** I2RS model supporting-termination-point node-ref QName */
    public static final QName I2RS_TP_NODE_REF = QName.create(
            org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf
            .network.topology.rev150608.network.node.termination.point.SupportingTerminationPoint.QNAME, "node-ref").intern();
