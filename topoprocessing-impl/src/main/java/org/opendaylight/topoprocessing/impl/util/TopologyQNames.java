...
public class TopologyQNames {
    ...
    public static final QName networkLinkIdQName = QName.create(Link.QNAME, "link-id");
    /** Network-topology terminationPoint-id QName */
    public static final QName networkTerminationPointIdQName = QName.create(
            TerminationPoint.QNAME, "terminationPoint-id");
