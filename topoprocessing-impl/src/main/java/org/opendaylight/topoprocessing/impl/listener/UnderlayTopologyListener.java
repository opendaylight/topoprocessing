...
public class UnderlayTopologyListener implements DOMDataChangeListener {
    ...
    public void readExistingData(YangInstanceIdentifier path, LogicalDatastoreType logicalDatastoreType) {
        ...
        Futures.addCallback(future, new FutureCallback<Optional<NormalizedNode<?, ?>>>() {
            ...
            public void onSuccess(Optional<NormalizedNode<?, ?>> result) {
                ...
                proceedChangeRequest(listToMap(((Set) result.get().getValue()).iterator(), underlayTopologyId),
        ...
        Map<YangInstanceIdentifier, NormalizedNode<?, ?>> map = Maps.uniqueIndex(nodes,
            ...
            public YangInstanceIdentifier apply(NormalizedNode<?, ?> node) {
                return YangInstanceIdentifier
                        ...
                        .node(Node.QNAME)
                        .nodeWithKey(Node.QNAME, TopologyQNames.NETWORK_NODE_ID_QNAME, node.getIdentifier())
                        .build();
            }
        });
