...
public class IRUnderlayTopologyListener extends UnderlayTopologyListener{
    ...
    public IRUnderlayTopologyListener(PingPongDataBroker pingPongBroker, String underlayTopologyId,
            CorrelationItemEnum correlationItem) {
        super(pingPongBroker, underlayTopologyId, correlationItem);
    }
    ...
    public void registerUnderlayTopologyListener(DatastoreType datastoreType,
        ...
        if (correlationItem.equals(CorrelationItemEnum.Node)) {
            ...
            IRInventoryListener invListener = new IRInventoryListener(dataBroker, underlayTopologyId, correlationItem);
