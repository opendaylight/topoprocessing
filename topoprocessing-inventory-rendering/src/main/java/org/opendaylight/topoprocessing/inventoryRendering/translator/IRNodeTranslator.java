...
public class InventoryRenderingNodeTranslator implements NodeTranslator {
    ...
    private MapEntryNode createTerminationPoint(MapEntryNode nodeConnectorEntry) {
        ...
        tpAugmentationBuilder.withNodeIdentifier(augId)
                .withChild(ImmutableNodes.leafNode(InventoryRenderingQNames.TP_AUG_CURRENT_SPEED_QNAME,
                        NormalizedNodes.findNode(nodeConnectorEntry, YangInstanceIdentifier.of(
                                InventoryRenderingQNames.OPEN_FLOW_PORT_CURRENT_SPEED_QNAME)).orNull()))
                .withChild(ImmutableNodes.leafNode(InventoryRenderingQNames.TP_AUG_HARDWARE_ADDRESS_QNAME,
                        NormalizedNodes.findNode(nodeConnectorEntry, YangInstanceIdentifier.of(
                                InventoryRenderingQNames.OPEN_FLOW_PORT_HARDWARE_ADDRESS_QNAME)).orNull()))
                .withChild(ImmutableNodes.leafNode(InventoryRenderingQNames.TP_AUG_MAXIMUM_SPEED_QNAME,
                        NormalizedNodes.findNode(nodeConnectorEntry, YangInstanceIdentifier.of(
                                InventoryRenderingQNames.OPEN_FLOW_PORT_MAXIMUM_SPEED_QNAME)).orNull()))
                .withChild(ImmutableNodes.leafNode(InventoryRenderingQNames.TP_AUG_NAME_QNAME,
                        NormalizedNodes.findNode(nodeConnectorEntry, YangInstanceIdentifier.of(
                                InventoryRenderingQNames.OPEN_FLOW_PORT_NAME_QNAME)).orNull()));
