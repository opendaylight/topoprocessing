...
public class IRNodeTranslator implements NodeTranslator {
    ...
    public NormalizedNode<?, ?> translate(OverlayItemWrapper wrapper) {
        ...
        // we don't use id from wrapper for our new node node-id. We have to change it to the correct one
    ...
    private MapEntryNode createTerminationPoint(MapEntryNode nodeConnectorEntry,
        ...
        String tpId = terminationPointsIds.get(nodeConnectorPath);
        terminationPointsIds.remove(nodeConnectorPath);
