...
import org.opendaylight.topoprocessing.inventoryRendering.translator.InventoryRenderingLinkTranslator;
import org.opendaylight.topoprocessing.inventoryRendering.translator.InventoryRenderingNodeTranslator;
 ...
 *
 */
public class InventoryRenderingAdapter implements ModelAdapter {
    ...
    public OverlayItemTranslator createOverlayItemTranslator() {
        return new OverlayItemTranslator(new InventoryRenderingNodeTranslator(), new InventoryRenderingLinkTranslator());
    }
