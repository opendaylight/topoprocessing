...
public class MultitechnologyAttributeParserImplTest {
    private static final Logger LOG = LoggerFactory.getLogger(MultitechnologyAttributeParserImplTest.class);
