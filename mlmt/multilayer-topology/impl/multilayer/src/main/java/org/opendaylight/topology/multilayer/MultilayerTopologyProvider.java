...
public class MultilayerTopologyProvider implements MultilayerTopologyProviderRuntimeMXBean,
    ...
    private void createTp(WriteTransaction transaction, FaId outFaId, InstanceIdentifier<Topology> topologyInstanceId,
            NodeKey nodeKey, TerminationPointBuilder tpBuilder) {
    ...
    private boolean checkLinkPresence(InstanceIdentifier<Topology> topologyInstanceId, TpId tpId, List<LinkId> linkToExclude) {
        ...
        try {
            ...
            if (headEnd != null) {
                ...
                InstanceIdentifier<TerminationPoint> tpInstanceId = topologyInstanceId
                        .child(Node.class, new NodeKey(headNodeId)).child(TerminationPoint.class, tpBuilder.getKey());
                transaction.merge(LogicalDatastoreType.OPERATIONAL, tpInstanceId, tpBuilder.build());
            }
            ...
            if (tailEnd != null) {
                ...
                InstanceIdentifier<TerminationPoint>  tpInstanceId = topologyInstanceId.child(Node.class, new NodeKey(tailNodeId))
            ...
            if (FaOperStatus.forValue(faOperStatus.getIntValue()) == FaOperStatus.Up) {
                ...
                log.info("MultilayerTopologyProvider.forwardingAdjUpdate RPC: delete link " + linkInstanceId.toString());
    ...
    public Future<RpcResult<ForwardingAdjWithdrawOutput>> forwardingAdjWithdraw(ForwardingAdjWithdrawInput input)  {
        ...
        if (forwardingAdjacencyProvider != null) {
            forwardingAdjacencyProvider.onForwardingAdjacencyDeleted(LogicalDatastoreType.OPERATIONAL, topologyInstanceId,
                    faId);
        }
