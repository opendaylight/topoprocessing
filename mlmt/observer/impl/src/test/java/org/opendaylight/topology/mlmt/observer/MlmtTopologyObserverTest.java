...
public class MlmtTopologyObserverTest extends AbstractConcurrentDataBrokerTest {
    ...
    public void setUp() throws Exception {
        ...
        dataBroker.registerDataTreeChangeListener(new DataTreeIdentifier<>(LogicalDatastoreType.OPERATIONAL,
                topologyIid), new ChangeListener());
        ...
        List<String> underlyingTopologyList = new ArrayList<>();
        ...
        if (optional.isPresent()) {
            assertTrue("Configuration mlmt:1 topology not present", optional.isPresent());
    ...
    private void handleObservedTopologyCreated(boolean multitech) throws Exception {
        ...
        tpBuilder.setKey(tpKey);
        tpBuilder.setTpId(tpId);
        List<TerminationPoint> lTp = new ArrayList<>();
